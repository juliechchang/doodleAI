...
class Model(object):
  ...
  def cnn_encoder():
    final_tensor = cnn_fn.cnn_model_fn( #returns forward and backward tensors
        self.enc_cell_fw,
        self.enc_cell_bw,
        batch,
  ...
  def build_model(self, hps):
    ...
    n_out = (3 + self.num_mixture * 6) #output (Gaussian * 6 + 3 for logits)
